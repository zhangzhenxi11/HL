...
public:
	...
	// ���磺GET:STATE/parameter1
	//            
	//Command ���ɣ� Type : Message    Message����: Base/parameter   
...
public:
	// response ACK for command ��ӦACK���� ,�ڸտ�ʼ���ӵ�ʱ���ͻ����õ�������sendxx�ӿ��ò�����
