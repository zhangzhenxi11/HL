...
*@brief  rotate command for rnd  aligner subsystem
*/
class  EFEMAlignerRotateCommand : public AlignerAbstractRotateCommand, public  TcpEfemCommandExecuter
{
public:
	DECLARE_PTR(EFEMAlignerRotateCommand) 
	EFEMAlignerRotateCommand(TcpEfemSubSystemHelper* hexHelper, unsigned int angle);
