...
#ifndef _XLH_EFEM_LOADPORT_STATUS_COMMAND_INCLUDE_
#define _XLH_EFEM_LOADPORT_STATUS_COMMAND_INCLUDE_
...
* @brief   update status command for rnd  aligner subsystem
*/
class  EFEMLoadPortStatusCommand : public KernelSubsystemUpdateCommand
{
public:
	DECLARE_PTR(EFEMLoadPortStatusCommand) 
	EFEMLoadPortStatusCommand();
...
private:
	DECLARE_PRIVATE(EFEMLoadPortStatusCommand)
};
