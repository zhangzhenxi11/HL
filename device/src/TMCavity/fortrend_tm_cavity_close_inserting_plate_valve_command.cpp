...
namespace FC{
	...
	/**
	* TMCavityCloseInsertingPlateValveCommand
	*/
	TMCavityCloseInsertingPlateValveCommand::TMCavityCloseInsertingPlateValveCommand(KeyencePlcSubSystemHelper* hexHelper)
	...
	*/
	TMCavityCloseInsertingPlateValveCommand::RunResult TMCavityCloseInsertingPlateValveCommand::onRun() throw(KernelException){
